...
void Wave::set_startingHealth(int value)
{
    if (value > 0)
        ...
        printf("The starting health cannot be lower than 1.");
}
...
{
    if (value > 0)
        this->nrofEnemies = value;
    else
        printf("The number of enemies cannot be lower than 1.");
}
...
void Wave::set_moneyperEnemy(float value)
{
    if (value > 0)
        ...
        printf("The money drop per enemy cannot be lower than 1.");
}